...
/**
 * UMUCorpusClassifier Contact Form 
 *
...
$email = (new Email())
    ...
    ->subject ('Petición de acceso a UMUCorpusClassifier de ' . $request_payload['email'])
...
$email = (new Email())
    ...
    ->subject ('You have sent a request for using UMUCorpusClassifier')
